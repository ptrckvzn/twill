...
export default {
  ...
  get(params, callback) {
    axios
      .get(window[process.env.VUE_APP_NAME].CMS_URLS.index, { params: params })
      .then(
        function (resp) {
  ...
  togglePublished(row, callback, errorCallback) {
    axios
      .put(window[process.env.VUE_APP_NAME].CMS_URLS.publish, {
        id: row.id,
  ...
  toggleFeatured(row, callback) {
    axios
      .put(window[process.env.VUE_APP_NAME].CMS_URLS.feature, {
        id: row.id,
        active: row.featured
      })
      .then(
  ...
  restore(row, callback) {
    axios
      .put(window[process.env.VUE_APP_NAME].CMS_URLS.restore, { id: row.id })
      .then(
        function (resp) {
          if (callback && typeof callback === 'function') callback(resp)
        },
  ...
  destroy(row, callback) {
    axios
      .put(window[process.env.VUE_APP_NAME].CMS_URLS.forceDelete, {
        id: row.id
      })
      .then(
        function (resp) {
  ...
  reorder(ids, callback) {
    axios
      .post(window[process.env.VUE_APP_NAME].CMS_URLS.reorder, { ids: ids })
      .then(
        function (resp) {
          if (callback && typeof callback === 'function') callback(resp)
        },
  ...
  bulkPublish(params, callback) {
    axios
      .post(window[process.env.VUE_APP_NAME].CMS_URLS.bulkPublish, {
        ids: params.ids,
        publish: params.toPublish
      })
      .then(
        function (resp) {
          if (callback && typeof callback === 'function') callback(resp)
  ...
  bulkFeature(params, callback) {
    axios
      .post(window[process.env.VUE_APP_NAME].CMS_URLS.bulkFeature, {
        ids: params.ids,
        feature: params.toFeature
      })
      .then(
        function (resp) {
          if (callback && typeof callback === 'function') callback(resp)
  ...
  bulkDelete(ids, callback) {
    axios
      .post(window[process.env.VUE_APP_NAME].CMS_URLS.bulkDelete, { ids: ids })
      .then(
        function (resp) {
          if (callback && typeof callback === 'function') callback(resp)
        },
  ...
  bulkRestore(ids, callback) {
    axios
      .post(window[process.env.VUE_APP_NAME].CMS_URLS.bulkRestore, { ids: ids })
      .then(
        function (resp) {
          if (callback && typeof callback === 'function') callback(resp)
        },
  ...
  bulkDestroy(ids, callback) {
    axios
      .post(window[process.env.VUE_APP_NAME].CMS_URLS.bulkForceDelete, {
        ids: ids
      })
      .then(
        function (resp) {
