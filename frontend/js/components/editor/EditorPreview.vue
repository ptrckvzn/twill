<template>
  <div
    class="editorPreview"
    :editorPreviewClass="editorPreviewClass"
    @mousedown="unselectBlock"
  >
    ...
    >
      <div
        ...
        :class="{
          'editorPreview__item--active': isBlockActive(block.id),
          'editorPreview__item--hover': activeItem === index
        }"
      ...
      >
        ...
        <div
          ...
          @click.prevent="selectBlock(index)"
        ></div>
